...
from app.models.schemas import DailyLogRecord, DailySummary, FoodItem, MealBasketItem, MealLogCreate
...
class NutritionService:
    ...
    def get_daily_logs(self, *, user_name: str, target_date: date) -> list[DailyLogRecord]:
